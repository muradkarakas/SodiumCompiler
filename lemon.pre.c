...
static const YYACTIONTYPE yy_action[] = {
 /*     0 */   119,   86,   24,   79,    6,   17,    5,    4,    3,   13,
 /*    10 */     2,   97,   86,   24,   96,    6,    7,    5,    4,    3,
 /*    20 */    13,    2,   10,   69,   10,   96,  140,    1,    1,    1,
 /*    30 */     1,   18,   81,   81,   81,   18,   73,   20,   68,   10,
 /*    40 */    91,   18,   21,   67,   10,   18,   19,   22,   70,   10,
 /*    50 */    23,   66,   10,   16,   72,   11,   15,   14,    8,   98,
 /*    60 */    99,   74,   90,   93,   12,   12,   89,   93,   77,   76,
 /*    70 */    75,    9,   96,   94,   65,   71,   64,   63,   62,   61,
 /*    80 */    87,
};
...
static const YYACTIONTYPE yy_default[] = {
 /*     0 */   139,  139,  139,  139,  139,  139,  139,  117,  139,  139,
 /*    10 */   139,  117,  139,  139,  139,  139,  139,  139,  124,  139,
...
static const char *const yyRuleName[] = {
 ...
 /*  11 */ "parameterlist ::= openparenthesis parameters closeparenthesis",
...
#line 69 "lemon.pre.yy"
{
    ASTNode_Statement_Variable_Declaration* stmVarDeclaration =
        new ASTNode_Statement_Variable_Declaration(yymsp[-1].minor.yy0, ASTNodePrimitiveDataType_String, ASTNODE_SCOPE_GLOBAL);
...
{
    ASTNode_Statement_Variable_Declaration* stmVarDeclaration =
        new ASTNode_Statement_Variable_Declaration(yymsp[-1].minor.yy0, ASTNodePrimitiveDataType_Bool, ASTNODE_SCOPE_GLOBAL);
...
{
    ASTNode_Statement_Variable_Declaration* stmVarDeclaration =
        new ASTNode_Statement_Variable_Declaration(yymsp[-1].minor.yy0, ASTNodePrimitiveDataType_Number, ASTNODE_SCOPE_GLOBAL);
...
{
    ASTNode_Statement_Variable_Declaration* stmVarDeclaration =
        new ASTNode_Statement_Variable_Declaration(yymsp[-1].minor.yy0, ASTNodePrimitiveDataType_DateTime, ASTNODE_SCOPE_GLOBAL);
...
{
    ASTNode_Statement_Variable_Declaration* stmVarDeclaration = 
        new ASTNode_Statement_Variable_Declaration(yymsp[-1].minor.yy0, ASTNodePrimitiveDataType_Redis, ASTNODE_SCOPE_GLOBAL);
...
#line 1061 "lemon.pre.c"
  yymsp[-2].minor.yy0 = yylhsminor.yy0;
        break;
      case 11: /* parameterlist ::= openparenthesis parameters closeparenthesis */
#line 214 "lemon.pre.yy"
{
...
#line 1071 "lemon.pre.c"
      ...
      case 13: /* parameters ::= parameter */ yytestcase(yyruleno==13);
#line 221 "lemon.pre.yy"
{
...
#line 1115 "lemon.pre.c"
}
        break;
      case 17: /* parameter ::= */
#line 261 "lemon.pre.yy"
{
...
#line 1168 "lemon.pre.c"
  yy_destructor(yypParser,12,&yymsp[0].minor);
}
        break;
      case 32: /* function_body_line ::= PRE_FUNCTION_BODY_LINE */
{  yy_destructor(yypParser,13,&yymsp[0].minor);
#line 204 "lemon.pre.yy"
{
}
#line 1177 "lemon.pre.c"
}
        break;
      case 35: /* enter ::= PRE_ENTER */
{  yy_destructor(yypParser,14,&yymsp[0].minor);
#line 272 "lemon.pre.yy"
{
}
#line 1185 "lemon.pre.c"
}
        break;
      case 36: /* openparenthesis ::= PRE_OPEN_PARAN */
{  yy_destructor(yypParser,16,&yymsp[0].minor);
#line 286 "lemon.pre.yy"
{
}
#line 1193 "lemon.pre.c"
}
        break;
      case 37: /* closeparenthesis ::= PRE_CLOSE_PARAN */
{  yy_destructor(yypParser,17,&yymsp[0].minor);
#line 287 "lemon.pre.yy"
{
}
#line 1201 "lemon.pre.c"
}
        break;
      case 38: /* comma ::= PRE_COMMA */
{  yy_destructor(yypParser,18,&yymsp[0].minor);
#line 289 "lemon.pre.yy"
{
}
#line 1209 "lemon.pre.c"
}
        break;
      default:
      /* (19) start ::= expressions */ yytestcase(yyruleno==19);
      /* (20) expressions ::= expressions expression */ yytestcase(yyruleno==20);
      /* (21) expressions ::= expression (OPTIMIZED OUT) */ assert(yyruleno!=21);
      /* (22) expression ::= comment (OPTIMIZED OUT) */ assert(yyruleno!=22);
      /* (23) expression ::= globals (OPTIMIZED OUT) */ assert(yyruleno!=23);
      /* (24) expression ::= enters */ yytestcase(yyruleno==24);
